...
For swell notes, each shake gives 300 and finishing the swell gives score twice as much as a GREAT of the current combo.
...
With the existence of swell and large notes, score loss would be larger.
...
Additionally, all hit notes gain a 1.2x score multiplier, long yellow notes (drumroll) included, except for hits on a swell (the final hit is still multiplied).
...
- Each swell gives a constant GREAT Score Value (300) without Kiai Time bonus except for last swell, which gives a large GREAT Score Value (600) with current combo multiplier.
